	 ...
	 public Properties p;
		 ...
		 public void setup(String os, String br) throws IOException
		{
			...
			if(p.getProperty("execution_env").equalsIgnoreCase("remote"))
			{
				...
				{
					System.out.println("No macting os");
					return;
				}
				...
				default:System.out.println("No macting browser");return;
				}
			...
			driver.get(p.getProperty("appURL"));//READ VALUE FROM PROPERTY FILE
